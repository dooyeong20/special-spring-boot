...
import static com.example.oauth2.user.SocialType.*;

@Configuration
@EnableWebSecurity
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    // https://blog.neonkid.xyz/237
    ...
    public void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.authorizeRequests()
                ...
                .and()
                    ...
                    .userInfoEndpoint().userService(new CustomOAuth2UserService())  // 네이버,카카오 USER INFO의 응답을 처리하기 위한 설정
                .and()
